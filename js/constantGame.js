const STORAGE_DATA = {
  config: {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { letter:"b", text: "心想：蛤…他們會不會在說我壞話…", score: { B: 3 } },
          {
            letter:"c",
      ...
      },
      {
        ...
        options: [
          { letter:"a", text: "沒問題！這個任務我一定可以解決", score: { C: 1 } },
          {
            letter:"b",
      ...
      },
      {
        ...
        options: [
          {
            letter:"a",
            text: "老闆的話怎能不理！笑著應對：「了解，馬上處理！」",
            score: { A: 3 },
          },
          { letter:"b", text: "笑著謙讓，並想辦法推給其他同事", score: { A: 1 } },
          {
            letter:"c",
      ...
      },
      {
        ...
        options: [
          { letter:"a", text: "立刻調整計劃，計算能做多少修改", score: { E: 3 } },
          {
            letter:"b",
            text: "忍不住翻白眼，心想「為什麼不早點說？」，但還是協助處理",
            score: { E: 1 },
          },
      ...
      },
      {
        ...
        options: [
          ...
          { letter:"c", text: "跟主管討論有沒有辦法降低目標", score: { D: 1 } },
        ],
      },
    ],
    buttons: {
    ...
    desktop: {
      ...
      buttons: {
        startButton: "/test-case/images/buttons/desktop-start-button.png",
